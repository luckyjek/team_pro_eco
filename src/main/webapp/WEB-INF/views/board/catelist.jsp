 ...
 <head>
                    ...
                    <div class="col-md-3">
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/board/catelist?category=22"><i class="fa fa-plus-square"></i>헬스/건강식품</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/board/catelist?category=1"><i class="fa fa-child"></i>식품</a>
                             
                                 <li class="nav-item">
                                    <a class="nav-link" href="/board/catelist?category=2"><i class="fa fa-microchip"></i>가구</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/board/catelist?category=4"><i class="fa fa-mobile-alt"></i>생활용품</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/board/catelist?category=23"><i class="fa fa-microchip"></i>주방용품</a>
                                </li>
	...
	<!-- 카테고리 클릭->상품목록 페이지 끝 -->
        ...
        $(document).ready(function(){
      	...
      	//카테고리 클릭시
      	$('.CateList').on('click', "뷰티",function () {
      		var cate_seq =  $(this).data("cate_seq");
        	console.log("버튼클릭cate_seq: "+cate_seq);
