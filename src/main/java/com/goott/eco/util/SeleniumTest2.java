...
public class SeleniumTest2 {
	public static void main(String[] args) {
		...
		try {
			...
			// 블로그 URL로 접속
			driver.get("https://www.coupang.com/vp/products/173189761?isAddedCart=");
			
			// 대기 설정
			driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
			
			
			List<WebElement> elements = driver.findElements(By.cssSelector(".product-detail"));
			elements.get(0).click();
			
			WebElement detail = driver.findElement(By.id("productDetail"));
